...
def build_production_graph(
    ...
    # In dry-run the deliver node writes nothing to git or GitHub, so the
    # GitHub client — and by extension the token — is not needed for the wiring.
    if dry_run:
        deliver_node = make_dry_run_deliver_node()
    else:
